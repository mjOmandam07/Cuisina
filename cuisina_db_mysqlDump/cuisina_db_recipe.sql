...
CREATE TABLE `recipe` (
  ...
  `time_date_posted` datetime NOT NULL,
  ...
  CONSTRAINT `recipe_ibfk_2` FOREIGN KEY (`comment`) REFERENCES `can_comment` (`comment_id`),
  CONSTRAINT `recipe_ibfk_3` FOREIGN KEY (`rate`) REFERENCES `can_rate` (`rate_id`)
...
-- Dump completed on 2020-12-12 10:01:40
