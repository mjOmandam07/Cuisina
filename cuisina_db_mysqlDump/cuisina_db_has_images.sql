...
CREATE TABLE `has_images` (
  ...
  CONSTRAINT `has_images_ibfk_1` FOREIGN KEY (`recipe_id`) REFERENCES `recipe` (`recipe_id`),
  CONSTRAINT `has_images_ibfk_2` FOREIGN KEY (`image_id`) REFERENCES `images` (`image_id`)
