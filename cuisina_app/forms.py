...
from wtforms import StringField, SubmitField, SelectField, PasswordField, TextAreaField, RadioField, SelectMultipleField
...
class CreatePost(FlaskForm):
    ...
    cuisine = SelectField('Cusine', choices=[('', 'Select Cuisine'), ('Filipino', 'Filipino'), ('Western', 'Western'),
                                             ('Chinese', 'Chinese'), ('European', 'European'), ('Italian', 'Italian'),
                                             ('Indian', 'Indian'), ('French', 'French'), ('Japanese', 'Japanese'),
                                             ('Mexican', 'Mexican'), ('Thai', 'Thai'), ('Turkish', 'Turkish'),
                                             ('Korean', 'Korean'), ('Spanish', 'Spanish'),
                                             ('Middle Eastern', 'Middle Eastern')], validators=[DataRequired()])
...
class rateForm(FlaskForm):
    rate = RadioField('rate', choices=[('5', ''), ('4', ''), ('3', ''), ('2', ''), ('1', '')],
                      validators=[DataRequired()])
